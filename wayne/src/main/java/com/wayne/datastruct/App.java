...
public final class App {
    ...
    public static void main(String[] args) {
        ...
        queue.insert(DEQueue.QueuePosition.FRONT,1);
        queue.insert(DEQueue.QueuePosition.FRONT,2);
        queue.insert(DEQueue.QueuePosition.FRONT,3);
        queue.insert(DEQueue.QueuePosition.FRONT,4);
        queue.insert(DEQueue.QueuePosition.FRONT,5);
        queue.insert(DEQueue.QueuePosition.REAR,6);
        queue.delete(DEQueue.QueuePosition.REAR);
        queue.display();
    }
}
